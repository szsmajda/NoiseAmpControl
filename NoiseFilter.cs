...
namespace NoiseAmpControl
{
    ...
    {
        private static int _ch1Value;
        private static int _ch2Value;
        private static int _ch3Value;
        private static int _ch4Value;
        ...
        public static void StartCalculation(byte[] sourceBytes)
        {
            ...
            Console.WriteLine($"Ch1_value:{_ch1Value,0:D}\tCh2_value:{_ch2Value,0:D}\tCh3_value:{_ch3Value,0:D}\tCh4_value:{_ch4Value,0:D}\n\r\n");

            VolumeController();
        }

        private static int ConvertHextoInt(byte[] sourceBytes, int toIndex)
        {
            int charValue = 0;
